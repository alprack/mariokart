...
To describe our line of best fit, which should show the which should further show this relation, we need to create a linear model.
...
With this data, we can graph the residuals to further show the effectiveness of the relationship line.
...
We can safely say that the null hypothesis can be rejected. The cost of the items and the number of wheels are related in a positive way.\
