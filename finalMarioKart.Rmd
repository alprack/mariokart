...
Alternative: H1: b1 != 0, The quantity of wheels affects the auction price.\
...
To satisfy the question posed in the beginning of this report, much analysis was done, and resolved to one answer. The alternative hypothests, wherein the slope of the scatterplot of the number of wheels and the cost of the item is not equal to or reasonably near zero, is true.\
